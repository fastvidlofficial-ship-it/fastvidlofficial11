    ...
    <div className="disclaimer-page">
      ...
      <div className="container-blog">
        <section className="home-blog-article">
          <p className="home-blog-article-meta">Last updated: 20 April 2026</p>
          ...
          <h2 className="home-blog-article-h2">Who may submit</h2>
          <p className="home-blog-article-p">
          ...
          <h2 className="home-blog-article-h2">Where to send your notice</h2>
          <p className="home-blog-article-p">
            Email:{" "}
            <a href={`mailto:${COPYRIGHT_EMAIL}`} className="home-blog-article-link">
              {COPYRIGHT_EMAIL}
            </a>
          </p>
          <p className="home-blog-article-p">
          ...
          <h2 className="home-blog-article-h2">What to include (checklist)</h2>
          <p className="home-blog-article-p">
          ...
          <h2 className="home-blog-article-h2">Counter-notices and mistakes</h2>
          <p className="home-blog-article-p">
          ...
          <h2 className="home-blog-article-h2">Repeat policy</h2>
          <p className="home-blog-article-p">
          ...
          <h2 className="home-blog-article-h2">Related pages</h2>
          <ul className="disclaimer-list-simple">
            <li>
              <Link href="/disclaimer" className="home-blog-article-link">
                Disclaimer
              </Link>
            </li>
            <li>
