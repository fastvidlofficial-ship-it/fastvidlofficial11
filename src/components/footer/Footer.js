...
const socialLinks = [
  ...
  {
    name: "Pinterest",
    href: "https://www.pinterest.com/fastvidl/",
    ariaKey: "footer.pinterestAria",
    icon: (
      <svg viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
  ...
  return (
    <footer className={styles["footer"]}>
      <div className={styles["social-wrap"]}>
        <span className={styles["social-label"]}>{t("footer.followUs")}</span>
        <ul className={styles["social-links"]} role="list">
          {socialLinks.map(({ name, href, ariaKey, icon }) => (
            <li key={name}>
              <a
                href={href}
                target="_blank"
      ...
      <ul className={styles["Ul-d"]}>
        <li>
          <a href="/AboutUs">| {t("footer.aboutUs")} |</a>
        </li>
        <li>
        ...
        <li>
          <a href="/CookiePolicy">| {t("footer.cookiePolicy")} |</a>
        </li>
        <li>
          <a href="/TermsAndConditions">| {t("footer.terms")} |</a>
        </li>
      </ul>
      <p className={styles.affiliationDisclaimer}>{t("footer.affiliation")}</p>
